...
The JavaScript API for Amazon SNS is exposed through the `AWS.SNS` client class\. For more information, see [Class: AWS\.SNS](http://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/SNS.html) in the API reference\. 
