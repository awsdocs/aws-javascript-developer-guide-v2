...
+ In the [IAM console](https://console.aws.amazon.com/iam/), create an IAM role whose policy grants permission to invoke a Lambda function\. Set this role as the [unauthenticated role](https://docs.aws.amazon.com/cognito/latest/developerguide/identity-pools.html#change-the-role-associated-with-an-identity-type) for the Identity Pool created above.
