# AWS SDK for JavaScript Developer Guide for SDK v2.218.1
...
+ [SDK for JavaScript Code Examples](sdk-code-samples.md)
   ...
   + [AWS Lambda Examples](lambda-examples.md)
      + [Invoking a Lambda Function in a Browser Script](browser-invoke-lambda-function-example.md)
         + [Invoking a Lambda Function Code](browser-invoke-lambda-function-full.md)
      + [Writing a Lambda Function in Node.js](nodejs-write-lambda-function-example.md)
         + [Writing a Lambda Function Code](nodejs-write-lambda-function-example-full.md)
   + [Amazon S3 Examples](s3-examples.md)
      + [Uploading Photos to Amazon S3 from a Browser](s3-example-photo-album.md)
         + [Uploading Photos to Amazon S3 Code](s3-example-photo-album-full.md)
